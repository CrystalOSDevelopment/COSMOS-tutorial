...
namespace SoundTest
{
    public class ImprovedVBE
    {
        ...
        [ManifestResourceStream(ResourceName = "Youtube_tut.canvas.bmp")] public static byte[] Canvas;
        [ManifestResourceStream(ResourceName = "Youtube_tut.canvas.bmp")] public static byte[] Canvas2;
